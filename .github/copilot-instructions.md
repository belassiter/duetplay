# Project Rules for DuetPlay

You are working on the DuetPlay project. You must adhere to the following strictly, without requiring input from the user:
...
*   After the verification steps pass, add an entry to the journal quoting the user's prompt and summarizing the changes, using standard file editing commands. Include the date and time for each entry, and add new entries to the top of the file.
